        ...
        <Box>
            ...
            <Box sx={{paddingTop: '50px', justifyContent: 'space-around', display: 'flex', alignItems: 'center'}}>
                <Box sx={{display: 'flex', flexDirection: 'column', alignItems: 'flex-start'}}>
                    ...
                    <Typography level="h2" sx={{fontFamily: "Montserrat", fontSize: '32px', color: TextColor}}>STUDYTALK – социальная сеть для студентов</Typography>
                    <Typography level="h2" sx={{fontFamily: "Montserrat", fontSize: '32px', color: TextColor}}>создана специально для того, чтобы</Typography>
                    <Typography level="h2" sx={{fontFamily: "Montserrat", fontSize: '32px', color: TextColor}}>объединить студентов со всего мира и сделать</Typography>
                    <Typography level="h2" sx={{fontFamily: "Montserrat", fontSize: '32px', color: TextColor}}>процесс обучения более эффективным и</Typography>
                    <Typography level="h2" sx={{fontFamily: "Montserrat", fontSize: '32px', color: TextColor}}>увлекательным. В этой уникальной платформе</Typography>
                    <Typography level="h2" sx={{fontFamily: "Montserrat", fontSize: '32px', color: TextColor}}>студенты могут делиться своими знаниями,</Typography>
                    <Typography level="h2" sx={{fontFamily: "Montserrat", fontSize: '32px', color: TextColor}}>опытом и находить ответы на любые вопросы,</Typography>
                    <Typography level="h2" sx={{fontFamily: "Montserrat", fontSize: '32px', color: TextColor}}>связанные с учебой.</Typography>
                </Box>
